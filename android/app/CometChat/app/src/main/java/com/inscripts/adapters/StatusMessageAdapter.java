...
public class StatusMessageAdapter extends ArrayAdapter<String> {
    ...
    public StatusMessageAdapter(Context context, ArrayList<Status> listStatusMessages) {
        super(context, R.layout.custom_list_item_status_message);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null == view) {
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_list_item_status_message, parent, false);
