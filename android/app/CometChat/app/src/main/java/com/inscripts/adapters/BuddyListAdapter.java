...
public class BuddyListAdapter extends ArrayAdapter<Buddy> {
    ...
    public BuddyListAdapter(Context context, List<Buddy> objects) {
        super(context, R.layout.custom_list_item_one_on_one, objects);
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        LocalStorageFactory.LoadImageUsingURLBots(context,buddy.avatarURL,holder.avatar,R.drawable.vector_drawable_ic_default_avtar);
