...
import static com.inscripts.factories.URLFactory.getBaseURL;

public class OtherPlugins {

    private static final java.lang.String TAG = OtherPlugins.class.getSimpleName();
    ...
    public static boolean isHandWrite(String message) {
        return (message.contains(OtherPluginKeys.HANDWRITE_KEY) || message.contains(OtherPluginKeys.HANDWRITE_NEW_KEY));
    }
    ...
    public static String getHandwriteImageUrl(String message) {
        ...
        if (href.contains(URLFactory.PROTOCOL_PREFIX) || href.contains(URLFactory.PROTOCOL_PREFIX_SECURE)) {
            relHref = href;
        } else if(url!= null && !href.contains(url.getHost())){
            relHref = URLFactory.getWebsiteURL() + href;
        } else {
            relHref = url.getProtocol() +":" + href;
        }
        return relHref;
    }
    ...
    public static boolean isBotResponce(String message){
        ...
        return (message.contains("\"name\":\"bots\""));
    }
