...
public class CommonUtils {
    ...
    public static String checkOnlineStatus(Long lastseen) {
        if (lastseen == 0) {
            ...
            if (ladiff < 60000) {
                if (lang != null && null != lang.getMobile() && null != lang.getMobile().get158()) {
                    return lang.getMobile().get158();
                } else {
                    return "Online";
                }
            } else {
                if (lang != null && null != lang.getMobile() && null != lang.getMobile().get171()) {
                    return lang.getMobile().get171() + " " + convertTimestampToDate(lastseen);
                } else {
    ...
    public static Boolean isValidJson(String jsonData) {
        try {
            ...
            return true;
        } catch (JsonSyntaxException malformedException) {
            return false;
        }
    }
    ...
    public static void playSound(Context activity, String ringtone) {
        try {
    ...
    public  static Boolean checkApplicationType(String type){
        Boolean bool= false;
    ...
    public  static Boolean checkTextType(String type){
        Boolean bool= false;
    ...
    public static Boolean setFileType(String type, Uri uri){
        Boolean flag = false;
        if (type.contains(".")){
            String seg = type.split("\\.")[1];
            if (null != seg && !TextUtils.isEmpty(seg)){
