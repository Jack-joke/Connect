...
public class EmoticonHandler implements TextWatcher {
	...
	public EmoticonHandler(EditText editor, Context context) {
		...
		int actsize = Integer.parseInt(context.getResources().getString(R.string.emoji_size_actual)) +  Integer.parseInt(context.getResources().getString(R.string.emoji_size_extra));
