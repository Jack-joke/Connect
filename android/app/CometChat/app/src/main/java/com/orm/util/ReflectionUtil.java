...
public class ReflectionUtil {
    ...
    public static void customSetFieldValueFromCursor(Cursor cursor, Field field, Class<?> fieldType, Object object, String colName) {
        field.setAccessible(true);
        try {
            if (null == colName) {
                colName = NamingHelper.toSQLName(field);
            }
            ...
            if (colName.equalsIgnoreCase("id")) {
                ...
                field.set(object, new Timestamp(cursor.getLong(columnIndex)));
    ...
    public static List<Class> getDomainClasses(Context context) {
        ...
        try {
            List<String> classnames = getAllClasses(context);
