...
public class ImageUploadHelper {
    ...
    public ImageUploadHelper(Context c, String URL, ResultReceiver resultReceiver) {
        Logger.error("c Result receiver = "+resultReceiver);
    ...
    public void sendImageAjax() {
		if (CommonUtils.isConnected()) {
			try {
				...
				StringRequest request = new StringRequest(Method.POST, URL, new Listener<String>() {
					...
					public void onResponse(String response) {
                        Logger.error("ImageUploadHelper success responce = "+response);
						if (handler != null) {
                        ...
                        if(resultReceiver != null){
                            ...
                            bundle.putString("what",StaticMembers.AJAX_SUCCESS+"");
            ...
            if(resultReceiver != null){
                Bundle bundle = new Bundle();
                bundle.putString("obj",StaticMembers.PLEASE_CHECK_YOUR_INTERNET);
                bundle.putString("what",StaticMembers.AJAX_SUCCESS+"");
                resultReceiver.send(202,bundle);
            }
		}
