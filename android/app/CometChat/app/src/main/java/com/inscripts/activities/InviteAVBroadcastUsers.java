...
public class InviteAVBroadcastUsers extends SuperActivity implements AdapterView.OnItemClickListener, SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_invite_avbroadcast_users);
        ...
        if(language != null && null != language.getMobile() && language.getMobile().get32() != null){
            cancelBtn.setText(language.getMobile().get32());
        }
