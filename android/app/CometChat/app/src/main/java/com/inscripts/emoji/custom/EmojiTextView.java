...
public class EmojiTextView extends TextView {
	...
	public EmojiTextView(Context context) {
		 ...
		 */
		emojiSize = Integer.parseInt(context.getResources().getString(R.string.emoji_size_actual)) +  Integer.parseInt(context.getResources().getString(R.string.emoji_size_extra));
    ...
    public void setEmojiText(String text,int emojiSize) {
        // text = text.replace("\\u0026", "&").replace("\\u0025",
        // "%").replace("\\u002B", "+");
        CharSequence spanned = EmoticonUtils.getSmiledText(context, text, emojiSize);
	...
	public ImageGetter emojiGetter = new ImageGetter() {
		@Override
