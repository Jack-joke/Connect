...
public class ViewUserProfileActivity extends CustomChatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (null != buddy) {
            ...
            if (null != profileUrl) {
                ...
                LocalStorageFactory.LoadImageUsingURL(this,profileUrl,buddyProfileImage,R.drawable.default_avatar);
            }
            String status = buddy.status;
            if (TextUtils.isEmpty(status)) {
                statusImage.setImageResource(R.drawable.ic_user_available);
            } else {
                switch (status) {
                    ...
                    case CometChatKeys.StatusKeys.AWAY:
                        statusImage.setImageResource(R.drawable.ic_user_away);
                        break;
                    case CometChatKeys.StatusKeys.BUSY:
                        statusImage.setImageResource(R.drawable.ic_user_busy);
                        break;
                    case CometChatKeys.StatusKeys.OFFLINE:
                        statusImage.setImageResource(R.drawable.ic_user_offline);
                        break;
