...
public class StaticMembers {
    ...
    public static final String COMETCHAT_LOGINURL_SUFFIX_6 = "modules/ccCometChat/contrib/cometchat/";

    public static final String COMETCHAT_LOGINURL_SUFFIX_7 = "neutron/PF.Base/cometchat/";

    public static final String COMETCHAT_LOGINURL_SUFFIX_8 = "PF.Base/cometchat/";
