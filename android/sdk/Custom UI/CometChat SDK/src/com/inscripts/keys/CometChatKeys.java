...
public class CometChatKeys {
	...
	public static class HeartbeatKeys {
		public static long HEARTBEAT_INTERVAL = 3000;
		public static long CHATROOM_HEARTBEAT_INTERVAL = 3000;
	}
	...
	public static class ChatroomKeys {
		...
		public static final String POPOUT = "popout";
	...
	public static class AVBroadcastKeys {
		...
		public static final String BROADCAST_END_KEY = "CC^CONTROL_PLUGIN_BROADCAST_ENDCALL";
	...
	public static class AVchatKeys {
		...
		public static final String CALL_REJECTED = "CC^CONTROL_PLUGIN_AVCHAT_REJECTCALL";
		public static final String CALL_ENDED = "CC^CONTROL_PLUGIN_AVCHAT_ENDCALL";
		public static final String NO_ANSWER = "CC^CONTROL_PLUGIN_AVCHAT_NOANSWER";
		public static final String CALL_CANCEL = "CC^CONTROL_PLUGIN_AVCHAT_CANCELCALL";
		public static final String BUSY_CALL = "CC^CONTROL_PLUGIN_AVCHAT_BUSYCALL";
	...
	/**
	 * Used to set the keys releated to OneOnOne chat
	 * */
	public static class OneOnOneKeys {
		public static final String CURRENT_TIME = "currenttime";
		public static final String TYPING_TO = "typingto";
	}
