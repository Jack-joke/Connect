...
namespace Com.Inscripts.Activities {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.inscripts.activities']/class[@name='InviteAVBroadcastUsers']"
	[global::Android.Runtime.Register ("com/inscripts/activities/InviteAVBroadcastUsers", DoNotGenerateAcw=true)]
	public partial class InviteAVBroadcastUsers : global::Com.Inscripts.Utils.SuperActivity, global::Android.Support.V7.Widget.SearchView.IOnQueryTextListener, global::Android.Widget.AdapterView.IOnItemClickListener {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/inscripts/activities/InviteAVBroadcastUsers", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (InviteAVBroadcastUsers); }
		}

		protected InviteAVBroadcastUsers (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.inscripts.activities']/class[@name='InviteAVBroadcastUsers']/constructor[@name='InviteAVBroadcastUsers' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe InviteAVBroadcastUsers ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (InviteAVBroadcastUsers)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Inscripts.Activities.InviteAVBroadcastUsers __this = global::Java.Lang.Object.GetObject<global::Com.Inscripts.Activities.InviteAVBroadcastUsers> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.inscripts.activities']/class[@name='InviteAVBroadcastUsers']/method[@name='onItemClick' and count(parameter)=4 and parameter[1][@type='android.widget.AdapterView&lt;?&gt;'] and parameter[2][@type='android.view.View'] and parameter[3][@type='int'] and parameter[4][@type='long']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.inscripts.activities']/class[@name='InviteAVBroadcastUsers']/method[@name='onQueryTextChange' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.inscripts.activities']/class[@name='InviteAVBroadcastUsers']/method[@name='onQueryTextSubmit' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
