...
namespace Com.Inscripts.Adapters {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.inscripts.adapters']/class[@name='SelectColorGridAdapter']"
	[global::Android.Runtime.Register ("com/inscripts/adapters/SelectColorGridAdapter", DoNotGenerateAcw=true)]
	public partial class SelectColorGridAdapter : global::Android.Widget.BaseAdapter {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/inscripts/adapters/SelectColorGridAdapter", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (SelectColorGridAdapter); }
		}

		protected SelectColorGridAdapter (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Landroid_content_Context_Ljava_util_ArrayList_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.inscripts.adapters']/class[@name='SelectColorGridAdapter']/constructor[@name='SelectColorGridAdapter' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='java.util.ArrayList&lt;com.inscripts.pojos.ColorPojo&gt;']]"
		[Register (".ctor", "(Landroid/content/Context;Ljava/util/ArrayList;)V", "")]
		public unsafe SelectColorGridAdapter (global::Android.Content.Context p0, global::System.Collections.Generic.IList<global::Com.Inscripts.Pojos.ColorPojo> p1)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;

			IntPtr native_p1 = global::Android.Runtime.JavaList<global::Com.Inscripts.Pojos.ColorPojo>.ToLocalJniHandle (p1);
			try {
				JValue* __args = stackalloc JValue [2];
				__args [0] = new JValue (p0);
				__args [1] = new JValue (native_p1);
				if (GetType () != typeof (SelectColorGridAdapter)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Inscripts.Adapters.SelectColorGridAdapter __this = global::Java.Lang.Object.GetObject<global::Com.Inscripts.Adapters.SelectColorGridAdapter> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.Count;
		}
#pragma warning restore 0169
		...
		public override unsafe int Count {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.inscripts.adapters']/class[@name='SelectColorGridAdapter']/method[@name='getCount' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.inscripts.adapters']/class[@name='SelectColorGridAdapter']/method[@name='getItem' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.inscripts.adapters']/class[@name='SelectColorGridAdapter']/method[@name='getItemId' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.inscripts.adapters']/class[@name='SelectColorGridAdapter']/method[@name='getView' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='android.view.View'] and parameter[3][@type='android.view.ViewGroup']]"
