...
namespace Com.Inscripts.Adapters {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.inscripts.adapters']/class[@name='FixedIconStickerTabsAdapter']"
	[global::Android.Runtime.Register ("com/inscripts/adapters/FixedIconStickerTabsAdapter", DoNotGenerateAcw=true)]
	public partial class FixedIconStickerTabsAdapter : global::Java.Lang.Object {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/inscripts/adapters/FixedIconStickerTabsAdapter", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (FixedIconStickerTabsAdapter); }
		}

		protected FixedIconStickerTabsAdapter (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Landroid_app_Activity_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.inscripts.adapters']/class[@name='FixedIconStickerTabsAdapter']/constructor[@name='FixedIconStickerTabsAdapter' and count(parameter)=1 and parameter[1][@type='android.app.Activity']]"
		[Register (".ctor", "(Landroid/app/Activity;)V", "")]
		public unsafe FixedIconStickerTabsAdapter (global::Android.App.Activity p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (FixedIconStickerTabsAdapter)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Inscripts.Adapters.FixedIconStickerTabsAdapter __this = global::Java.Lang.Object.GetObject<global::Com.Inscripts.Adapters.FixedIconStickerTabsAdapter> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return JNIEnv.ToLocalJniHandle (__this.GetView (p0));
		}
#pragma warning restore 0169

		static IntPtr id_getView_I;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.inscripts.adapters']/class[@name='FixedIconStickerTabsAdapter']/method[@name='getView' and count(parameter)=1 and parameter[1][@type='int']]"
