...
namespace Com.Inscripts.Adapters {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.inscripts.adapters']/class[@name='EmojiGridviewImageAdapter']"
	[global::Android.Runtime.Register ("com/inscripts/adapters/EmojiGridviewImageAdapter", DoNotGenerateAcw=true)]
	public partial class EmojiGridviewImageAdapter : global::Android.Widget.BaseAdapter {

		// Metadata.xml XPath class reference: path="/api/package[@name='com.inscripts.adapters']/class[@name='EmojiGridviewImageAdapter.Holder']"
		[global::Android.Runtime.Register ("com/inscripts/adapters/EmojiGridviewImageAdapter$Holder", DoNotGenerateAcw=true)]
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/inscripts/adapters/EmojiGridviewImageAdapter", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (EmojiGridviewImageAdapter); }
		}

		protected EmojiGridviewImageAdapter (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Landroid_content_Context_Ljava_util_ArrayList_Lcom_inscripts_interfaces_EmojiClickInterface_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.inscripts.adapters']/class[@name='EmojiGridviewImageAdapter']/constructor[@name='EmojiGridviewImageAdapter' and count(parameter)=3 and parameter[1][@type='android.content.Context'] and parameter[2][@type='java.util.ArrayList&lt;java.lang.Integer&gt;'] and parameter[3][@type='com.inscripts.interfaces.EmojiClickInterface']]"
		[Register (".ctor", "(Landroid/content/Context;Ljava/util/ArrayList;Lcom/inscripts/interfaces/EmojiClickInterface;)V", "")]
		public unsafe EmojiGridviewImageAdapter (global::Android.Content.Context p0, global::System.Collections.Generic.IList<global::Java.Lang.Integer> p1, global::Com.Inscripts.Interfaces.IEmojiClickInterface p2)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (EmojiGridviewImageAdapter)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(Landroid/content/Context;Ljava/util/ArrayList;Lcom/inscripts/interfaces/EmojiClickInterface;)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, "(Landroid/content/Context;Ljava/util/ArrayList;Lcom/inscripts/interfaces/EmojiClickInterface;)V", __args);
					return;
				}

				if (id_ctor_Landroid_content_Context_Ljava_util_ArrayList_Lcom_inscripts_interfaces_EmojiClickInterface_ == IntPtr.Zero)
					id_ctor_Landroid_content_Context_Ljava_util_ArrayList_Lcom_inscripts_interfaces_EmojiClickInterface_ = JNIEnv.GetMethodID (class_ref, "<init>", "(Landroid/content/Context;Ljava/util/ArrayList;Lcom/inscripts/interfaces/EmojiClickInterface;)V");
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Landroid_content_Context_Ljava_util_ArrayList_Lcom_inscripts_interfaces_EmojiClickInterface_, __args),
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, class_ref, id_ctor_Landroid_content_Context_Ljava_util_ArrayList_Lcom_inscripts_interfaces_EmojiClickInterface_, __args);
			} finally {
...
#pragma warning disable 0169
		...
		{
			global::Com.Inscripts.Adapters.EmojiGridviewImageAdapter __this = global::Java.Lang.Object.GetObject<global::Com.Inscripts.Adapters.EmojiGridviewImageAdapter> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.Count;
		}
#pragma warning restore 0169
		...
		public override unsafe int Count {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.inscripts.adapters']/class[@name='EmojiGridviewImageAdapter']/method[@name='getCount' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.inscripts.adapters']/class[@name='EmojiGridviewImageAdapter']/method[@name='getItem' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.inscripts.adapters']/class[@name='EmojiGridviewImageAdapter']/method[@name='getItemId' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.inscripts.adapters']/class[@name='EmojiGridviewImageAdapter']/method[@name='getView' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='android.view.View'] and parameter[3][@type='android.view.ViewGroup']]"
