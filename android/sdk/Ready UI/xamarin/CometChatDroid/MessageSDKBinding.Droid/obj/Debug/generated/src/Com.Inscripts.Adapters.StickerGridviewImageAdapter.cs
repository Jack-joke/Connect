...
namespace Com.Inscripts.Adapters {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.inscripts.adapters']/class[@name='StickerGridviewImageAdapter']"
	[global::Android.Runtime.Register ("com/inscripts/adapters/StickerGridviewImageAdapter", DoNotGenerateAcw=true)]
	public partial class StickerGridviewImageAdapter : global::Android.Widget.BaseAdapter {

		// Metadata.xml XPath class reference: path="/api/package[@name='com.inscripts.adapters']/class[@name='StickerGridviewImageAdapter.Holder']"
		[global::Android.Runtime.Register ("com/inscripts/adapters/StickerGridviewImageAdapter$Holder", DoNotGenerateAcw=true)]
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/inscripts/adapters/StickerGridviewImageAdapter", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (StickerGridviewImageAdapter); }
		}

		protected StickerGridviewImageAdapter (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Landroid_content_Context_Ljava_util_ArrayList_Lcom_inscripts_interfaces_StickerClickInterface_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.inscripts.adapters']/class[@name='StickerGridviewImageAdapter']/constructor[@name='StickerGridviewImageAdapter' and count(parameter)=3 and parameter[1][@type='android.content.Context'] and parameter[2][@type='java.util.ArrayList&lt;java.lang.Integer&gt;'] and parameter[3][@type='com.inscripts.interfaces.StickerClickInterface']]"
		[Register (".ctor", "(Landroid/content/Context;Ljava/util/ArrayList;Lcom/inscripts/interfaces/StickerClickInterface;)V", "")]
		public unsafe StickerGridviewImageAdapter (global::Android.Content.Context p0, global::System.Collections.Generic.IList<global::Java.Lang.Integer> p1, global::Com.Inscripts.Interfaces.IStickerClickInterface p2)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (StickerGridviewImageAdapter)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(Landroid/content/Context;Ljava/util/ArrayList;Lcom/inscripts/interfaces/StickerClickInterface;)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, "(Landroid/content/Context;Ljava/util/ArrayList;Lcom/inscripts/interfaces/StickerClickInterface;)V", __args);
					return;
				}

				if (id_ctor_Landroid_content_Context_Ljava_util_ArrayList_Lcom_inscripts_interfaces_StickerClickInterface_ == IntPtr.Zero)
					id_ctor_Landroid_content_Context_Ljava_util_ArrayList_Lcom_inscripts_interfaces_StickerClickInterface_ = JNIEnv.GetMethodID (class_ref, "<init>", "(Landroid/content/Context;Ljava/util/ArrayList;Lcom/inscripts/interfaces/StickerClickInterface;)V");
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Landroid_content_Context_Ljava_util_ArrayList_Lcom_inscripts_interfaces_StickerClickInterface_, __args),
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, class_ref, id_ctor_Landroid_content_Context_Ljava_util_ArrayList_Lcom_inscripts_interfaces_StickerClickInterface_, __args);
			} finally {
...
#pragma warning disable 0169
		...
		{
			global::Com.Inscripts.Adapters.StickerGridviewImageAdapter __this = global::Java.Lang.Object.GetObject<global::Com.Inscripts.Adapters.StickerGridviewImageAdapter> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.Count;
		}
#pragma warning restore 0169
		...
		public override unsafe int Count {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.inscripts.adapters']/class[@name='StickerGridviewImageAdapter']/method[@name='getCount' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.inscripts.adapters']/class[@name='StickerGridviewImageAdapter']/method[@name='getItem' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.inscripts.adapters']/class[@name='StickerGridviewImageAdapter']/method[@name='getItemId' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.inscripts.adapters']/class[@name='StickerGridviewImageAdapter']/method[@name='getView' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='android.view.View'] and parameter[3][@type='android.view.ViewGroup']]"
