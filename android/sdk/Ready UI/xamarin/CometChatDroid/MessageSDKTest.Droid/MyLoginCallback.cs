...
{
	public class MyLoginCallback : Java.Lang.Object, ILoginCallbacks
    {
		...
		public MyLoginCallback(Action<Org.Json.JSONObject> onSuccess, Action<Org.Json.JSONObject> onFail , Action<Org.Json.JSONObject> onUserInfoCallback 
