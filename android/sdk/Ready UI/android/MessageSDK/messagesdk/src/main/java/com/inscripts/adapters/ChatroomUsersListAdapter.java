...
public class ChatroomUsersListAdapter extends ArrayAdapter<ChatroomMembers> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (null == convertView) {
            convertView = inflater.inflate(R.layout.cc_custom_list_item_chatroom_members, null);
        ...
        LocalStorageFactory.getPicassoInstance().load(member.getAvatarUrl()).placeholder(R.drawable.cc_default_avatar)
