...
public class App {
    ...
    private fm.android.conference.webrtc.Signalling signalling;
    private fm.android.conference.webrtc.LocalMedia localMedia;
    ...
    public void startSignalling(SingleAction<String> callback, String websyncUrl, boolean isBroadcast, boolean iamBroadcaster) {
        //if (signalling == null) {
        // Create and start the signalling engine.
        try {
            signalling = new fm.android.conference.webrtc.Signalling(websyncUrl);
            signalling.start(callback, isBroadcast, iamBroadcaster);
        } catch (Exception e) {
            e.printStackTrace();
        }
        /*} else {
    ...
    public void startLocalMedia(SingleAction<Exception> callback, boolean video, boolean audio) {
        if (localMedia == null) {
            ...
            localMedia = new fm.android.conference.webrtc.LocalMedia();
    ...
    public void startConference(final String iceLinkServerAddress, String roomName, boolean videoTrue,
                                ViewGroup videoContainer, final View wheel, final ImageView audioOnlyDefaultAvatar,
                                final ImageButton muteControlToggle, final ImageButton videoOnOffToggle, final ImageButton speakerToggle,
                                final Activity activity, boolean isBroadcast, final boolean iamBroadcaster, final SingleAction<Exception> callback) {
                                ...
                                try {
                                    ...
                                    activity.runOnUiThread(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            if (null != muteControlToggle) {
                                                muteControlToggle.setAlpha(1F);
                                            }
                                            if (null != videoOnOffToggle) {
                                                videoOnOffToggle.setAlpha(1F);
                                            }
                                            if (null != speakerToggle) {
                                                speakerToggle.setAlpha(1F);
                                            }
                                ...
                                if (null != wheel) {
                                    activity.runOnUiThread(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            if (null != audioOnlyDefaultAvatar) {
