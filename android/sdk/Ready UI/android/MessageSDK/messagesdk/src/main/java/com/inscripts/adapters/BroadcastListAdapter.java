...
public class BroadcastListAdapter extends ArrayAdapter<Buddy> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null == view) {
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cc_custom_broadcast_list_item, parent,
                    false);
        ...
        LocalStorageFactory.LoadImageUsingURL(parent.getContext(),buddy.avatarURL,holder.avatar,R.drawable.cc_default_avatar);
        ...
        switch (buddy.status) {
            case CometChatKeys.StatusKeys.AVALIABLE:
                holder.statusImage.setImageResource(R.drawable.cc_ic_user_available);
                break;
            case CometChatKeys.StatusKeys.AWAY:
                holder.statusImage.setImageResource(R.drawable.cc_ic_user_away);
                break;
            case CometChatKeys.StatusKeys.BUSY:
                holder.statusImage.setImageResource(R.drawable.cc_ic_user_busy);
                break;
            case CometChatKeys.StatusKeys.OFFLINE:
                holder.statusImage.setImageResource(R.drawable.cc_ic_user_offline);
                break;
