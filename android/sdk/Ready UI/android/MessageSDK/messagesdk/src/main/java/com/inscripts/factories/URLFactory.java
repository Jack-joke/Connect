...
public class URLFactory {
    ...
    private static final String BOT_URL = "extensions/bots/index.php?callbackfn=mobileapp";
        ...
        if (PreferenceHelper.contains(PreferenceKeys.DataKeys.API_KEY)) {
            ...
            if (apikey.contains("x")) {
                ...
                if (TextUtils.isDigitsOnly(apikey) && apikey.length() > 2) {
                    ...
                    PreferenceHelper.save(PreferenceKeys.LoginKeys.BASE_URL,
    ...
    public static String getBotsUrl() {
        return getCometChatURL() + BOT_URL;
    }
    ...
    public static String getWhiteBoardURL() {
        return getCometChatURL() + WHITEBOARD_URL;
    }

    public static String getWriteboardRequestUrl() {
        return getCometChatURL() + WRITEBOARD_URL;
    }
    ...
    public static String getHandwriteURL(){ return getCometChatURL() + HANDWRITE_URL;}
