...
public class ChatroomMessageAdapter extends ArrayAdapter<ChatroomMessage> implements StickyListHeadersAdapter {
    ...
    private static class ChatroomViewHolder {
        ...
        public ImageView imageHolder, videoThumb, videoMessageButton, audioPlayButton,customImageHolder;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (vi == null) {
            ...
            if (getItemViewType(position) == TYPE_RIGHT) {
                vi = LayoutInflater.from(getContext()).inflate(R.layout.cc_custom_chat_message_chatroom_right, parent,
                        false);
                ...
                vi = LayoutInflater.from(getContext()).inflate(R.layout.cc_custom_chat_message_chatroom_left, parent,
                        false);
        ...
        switch (message.type) {
            ...
            case CometChatKeys.MessageTypeKeys.IMAGE_NEW:
                ...
                holder.imageHolder.setImageDrawable(getContext().getResources().getDrawable(R.drawable.cc_thumbnail_default));
            ...
            case CometChatKeys.MessageTypeKeys.VIDEO_DOWNLOADED:
                ...
                if (video.exists()) {
                    ...
                    final ProgressBar wheel3 = holder.wheel;
			 ...
			 */
                holder.videoThumb.setVisibility(View.VISIBLE);
                final ProgressBar wheel4 = holder.wheel;
